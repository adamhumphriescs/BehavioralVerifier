...
public:
  ...
  ConstraintManager cheatConstraints; //Added for TASE to train path selection with
  //user input
...
public:
  ...
  void addCheatConstraint(ref <Expr> e) {cheatConstraints.addCheatConstraint(e) ;}
  void addConstraint(ref<Expr> e) {
    constraints.addConstraint(e);
    if(useCheatCons)
      addCheatConstraint(e);
  }
