...
public:
  ...
  /// contents.  Possible optimization added for tase to make the memory allocation
  /// of the underlying objects a bit faster.
...
private:
  ...
  //bool isByteFlushed(unsigned offset) const; ABH switched to public for use in faster register wiping logic
